...
const Hero = ({ offset, factor = 1 }: { offset: number; factor?: number }) => (
  <div>
    ...
    <Content sx={{ variant: `texts.bigger` }} speed={0.4} offset={offset} factor={factor}>
      <Inner>
        <Typist typingDelay={40} startDelay={500} cursor={<span className='cursor'>|</span>}>
          <h1 sx={{
            textShadow: '0 5px 35px rgba(255, 255, 255, 0.15)',
            fontSize: '5rem',
            marginBottom: '1.5rem'
          }}>Nice to meet you, <br />I'm Alex Oliynyk</h1>        
          <div sx={{
        ...
        <div sx={{ 
          ...
          <a 
           ...
           >Resume</a> | <a 
            ...
            target="_blank" 
            rel="noreferrer noopener"
            sx={{ color: "rgb(64, 191, 117)", '&:hover': {color: 'rgb(64, 191, 117)'}}}>Upwork profile</a>
